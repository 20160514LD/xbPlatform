				...
				<section class="no-padding-bottom">
					...
					<div class="col-lg-12">
						<div class="block">
							...
							<div class="avatar"><img src="../img/avatar-6.jpg" id="pic" alt="加载中..." style="width: 150px;height: 150px"
								...
								<form class="form-horizontal">
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											...
											<div class="i-checks">
												<input id="radioCustom1" type="radio" value="1" name="gender" class="radio-template">
												<label for="radioCustom1">男</label>
												<span>&nbsp;</span><span>&nbsp;</span><span>&nbsp;</span>
												<input id="radioCustom2" type="radio" value="0" name="gender" class="radio-template">
